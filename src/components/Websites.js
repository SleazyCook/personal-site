  ...
  return (
    <div>
      ...
      <div className="max-w-[600px] mx-auto text-center">
        ...
        {/* Movie Mayhem */}
        <div>
          <p className="text-center text-xl hover:text-gray-500"><a href="https://moviemayhem.netlify.app" target="_blank">
            Movie Mayhem</a></p>
          <p>
        ...
        {/* Beyond the Book */}
        <div>
          <p className="text-center text-xl hover:text-gray-500"><a href="https://beyondthebook.netlify.app" target="_blank">
            Beyond the Book</a></p>
          <p>
        ...
        {/* Drewford's List */}
        <div>
          <p className="text-center text-xl hover:text-gray-500"><a href="https://drewfordslist.netlify.app" target="_blank">
            Drewford's List</a></p>
          <p>
        ...
        {/* Homestead List */}
        <div>
          <p className="text-center text-xl hover:text-gray-500"><a href="https://homesteadlist.netlify.app" target="_blank">
